...
class MultiEpochDatasetResampler(Dataset[T_co]):
    ...
    normal_idx_getitem_behavior: bool = False
    """Whether to use the normal index getitem behavior, or the multi-epoch behavior."""
    ...
    def __getitem__(self, index: int) -> T_co:
        ...
        idx = self._global_index_to_permuted_local_index(index)
    ...
    def _global_index_to_permuted_local_index(self, index: int) -> EpochIndex:
        ...
        if self.normal_idx_getitem_behavior:
            return idx
        else:   
